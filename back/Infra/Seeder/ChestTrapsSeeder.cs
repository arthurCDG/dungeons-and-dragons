...
//            // Brume étouffante
//            new ChestTrapEffectDal { Id = 1, ChestTrapId = 1, Effect = ChestTrapEffectType.DecreaseAllCreaturesLifePointsBy1 },
//            new ChestTrapEffectDal { Id = 2, ChestTrapId = 1, Effect = ChestTrapEffectType.DoesNotAffectUndeads },
//            // Couverture de flammes
//            new ChestTrapEffectDal { Id = 3, ChestTrapId = 2, Effect = ChestTrapEffectType.DecreaseHeroLifePointsBy2 },
//            new ChestTrapEffectDal { Id = 4, ChestTrapId = 2, Effect = ChestTrapEffectType.DecreaseHeroNearByLifePointsBy2 },
//            // Voix des damnés
//            new ChestTrapEffectDal { Id = 5, ChestTrapId = 3, Effect = ChestTrapEffectType.MoveToRandomHero },
//            new ChestTrapEffectDal { Id = 6, ChestTrapId = 3, Effect = ChestTrapEffectType.AttackRandomHeroNearBy },
//            // Lumière aveuglante
//            new ChestTrapEffectDal { Id = 7, ChestTrapId = 4, Effect = ChestTrapEffectType.SkipNextTurn },
//            // Appel de la tombe
//            new ChestTrapEffectDal { Id = 8, ChestTrapId = 5, Effect = ChestTrapEffectType.ReviveLastDeadMonster },
//            // Trahison brutale
//            new ChestTrapEffectDal { Id = 9, ChestTrapId = 6, Effect = ChestTrapEffectType.Lose5LifePointsOrRandomHeroLoses3LifePoints },
//            // Perte de magie
//            new ChestTrapEffectDal { Id = 10, ChestTrapId = 7, Effect = ChestTrapEffectType.DecreaseHeroManaPointsBy4 }
//        );
//    }
//}
