...
namespace dnd_infra.Migrations
{
    ...
    [Migration("20240607093222_RenameArtifacts")]
    partial class RenameArtifacts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dnd_infra.Items.DALs.ArtifactDal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Artifacts", "Items");
                });

            modelBuilder.Entity("dnd_infra.Items.DALs.ArtifactEffectDal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ArtifactEffects", "Items");
                });
            ...
            modelBuilder.Entity("dnd_infra.Dice.DieAssociationDal", b =>
                {
                    b.HasOne("dnd_infra.Items.DALs.ArtifactDal", null)
                        .WithMany()
            ...
            modelBuilder.Entity("dnd_infra.Items.DALs.StoredItemDal", b =>
                {
                    b.HasOne("dnd_infra.Items.DALs.ArtifactDal", "Artifact")
                        .WithMany()
                        .HasForeignKey("ArtifactId")
                        .OnDelete(DeleteBehavior.Restrict);
